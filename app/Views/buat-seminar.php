        ...
        <section id="buat-seminar">
            ...
            <div class="px-2 max-w-2xl">
                <form action="buat-seminar" method="post">
                    ...
                    <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-emerald-700 rounded-lg focus:ring-4 focus:ring-emerald-600 hover:bg-emerald-800">
                        Buat Seminar
                    </button>
                </form>
            </div>
