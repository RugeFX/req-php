    ...
    <main class="flex-1 bg-gray-700 rounded-lg p-2">
        <section id="seminar-terbaru">
            ...
            <div class="max-w-sm p-6 bg-gray-600 border border-gray-400 rounded-lg mb-2">
                <div class="flex gap-2 w-full justify-center items-center mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-clock-history w-7 h-7 text-gray-400" viewBox="0 0 16 16">
                    ...
                    <span href="#">
                        <h5 class="text-2xl font-semibold tracking-tight text-emerald-400">Riwayat Sidang</h5>
                    </span>
                </div>
